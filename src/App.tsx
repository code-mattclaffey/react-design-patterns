  ...
  return (
    <main className="flex flex-col items-center justify-center bg-code-950 h-screen text-center text-white px-4">
      ...
      <p className="text-lg mb-8 max-w-2xl">
        Welcome to React Design Patterns 👋🏻! <br /> <br /> This course
        educates developers on best practices for writing React
        components, utilizing patterns and providing practical guides
