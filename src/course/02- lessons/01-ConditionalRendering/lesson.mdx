...
If I had a lot of complexity in this component that still would be getting excecuted but the component will just return nothing if it's not authenticated. The best way to return something like this is to do the conditional render outside of the Component, for example:
